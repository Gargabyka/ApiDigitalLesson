...
namespace ApiDigitalLesson.BL.Controller
{
    ...
    public class TypeLessonController : ControllerBase
    {
        ...
        public async Task<IActionResult> CreateTypeLessonAsync(TypeLessonDto typeLessonDto)
        {
            ...
            {
                var message =
                    $"Контроллер: {nameof(TypeLessonController)}. " +
                    $"Произошла ошибка при работе метода CreateTypeLessonAsync, {e.Message}";
        ...
        public async Task<IActionResult> UpdateTypeLessonAsync(TypeLessonDto typeLessonDto)
        {
            ...
            catch (Exception e)
            {
                var message =
                    $"Контроллер: {nameof(TypeLessonController)}. " +
                    $"Произошла ошибка при работе метода UpdateTypeLessonAsync, {e.Message}";
        ...
        public async Task<IActionResult> DeleteTypeLessonAsync(Guid id)
        {
            ...
            catch (Exception e)
            {
                var message =
                    $"Контроллер: {nameof(TypeLessonController)}. " +
                    $"Произошла ошибка при работе метода DeleteTypeLessonAsync, {e.Message}";
        ...
        public async Task<IActionResult> GetTypeLessonsAsync()
        {
            ...
            catch (Exception e)
            {
                var message =
                    $"Контроллер: {nameof(TypeLessonController)}. " +
                    $"Произошла ошибка при работе метода GetTypeLessonsAsync, {e.Message}";
